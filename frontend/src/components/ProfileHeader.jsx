...
import { LogOutIcon, VolumeOffIcon, Volume2Icon, FileInput } from "lucide-react";
...
function ProfileHeader() {
  ...
  return <div className='p-6 border-b bprder-slate-700/50'>
    <div className='flex items-center justify-between'>
      ...
      <div className="flex gap-4 items-center">
        {/* LOGOUT BTN */}
        <button
          className="text-slate-400 hover:text-slate-200 transition-colours" onClick={logout}
        >
